...
- (void)showLineWithButtonWidth:(CGFloat)width
{
    ...
    _line.backgroundColor = UIColorWithRGBA(251.0f, 72.0f, 87.0f, 0.7f);
...
- (CGFloat)contentWidthAndAddNavTabBarItemsWithButtonsWidth:(NSArray *)widths
{
    ...
    for (NSInteger index = 0; index < [_itemTitles count]; index++)
    {
        ...
        [button setTitleColor: UIColorWithRGBA(251.0f, 72.0f, 87.0f, 0.7f) forState:UIControlStateSelected];
...
//    }
    ...
    NSNumber *width = [NSNumber numberWithFloat:SCREEN_WIDTH/4.0];
